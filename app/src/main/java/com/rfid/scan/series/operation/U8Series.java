package com.rfid.scan.series.operation;
...
import com.rfid.scan.UHFApplication;
import com.rfid.scan.series.model.IResponseHandler;
import com.rfid.scan.series.model.Message;
import com.rfid.scan.series.reader.CMD;
import com.rfid.scan.series.reader.ERROR;
import com.rfid.scan.series.reader.model.InventoryBuffer;
import com.rfid.scan.series.reader.model.InventoryBuffer.InventoryTagMap;
import com.rfid.scan.series.reader.model.OperateTagBuffer;
import com.rfid.scan.series.reader.model.ReaderSetting;
import com.rfid.scan.series.reader.server.ReaderBase;
...
public class U8Series implements IUSeries {
	 ...
	 *
	 * @see LOCK_FREE解锁
	 * @see LOCK_FREE_EVER永久解锁
	 * @see LOCK_LOCK锁
	 * @see LOCK_LOCK_EVER永久锁定
	 */
